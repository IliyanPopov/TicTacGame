...
public class TicTacGameActivity extends Activity {
	...
	public static final String androidWins= "Android Wins";
	public static final String humanWins= "Human Wins";
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		inflater.inflate(R.menu.tic_tac_game, menu);
			...
			if (!mGameOver) {
				if (mBoardButtons[location].isEnabled()) {
					...
					if (winner == 0)
						...
						ticTacToeScore.setScore(tie);
						ticTacToeScore.setTime(System.currentTimeMillis());
						db.addScore(ticTacToeScore);
						...
						mGameOver = true;
						TicTacToeScore ticTacToeScore= new TicTacToeScore();
						ticTacToeScore.setScore(humanWins);
						ticTacToeScore.setTime(System.currentTimeMillis());
						db.addScore(ticTacToeScore);
						...
						mGameOver = true;
						TicTacToeScore ticTacToeScore= new TicTacToeScore();
						ticTacToeScore.setScore(androidWins);
						ticTacToeScore.setTime(System.currentTimeMillis());
						db.addScore(ticTacToeScore);
					}
				}
